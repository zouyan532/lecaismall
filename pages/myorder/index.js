...
Page({
    ...
    onLoad: function (options) {
        this.setData({
            ...
            currentType:this.data.types[options.index].type
        })
        this.getOrdersByType(true)
    },
    clicktype: function (e) {
        this.setData({
            typeIndex: e.currentTarget.dataset.index,
            currentType:this.data.types[e.currentTarget.dataset.index].type
        })
        this.getOrdersByType(true)
    },
    getOrdersByType: function (isRefresh) {
        if (isRefresh) {
            this.setData({
                offset: 0,
                hasMore: true
